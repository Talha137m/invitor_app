...
class _DataCollectionState extends State<DataCollection>
  ...
  void initializeHintTextList({String categoryTitle = ''}) {
    switch (categoryTitle) {
      ...
      case 'Party':
        {
          initializePartyHintTextList(partySubCategoryTitle: subCategoryTitle);
          break;
        }
      case 'Babies & Kids':
        {
  ...
  Widget build(BuildContext context) {
    ...
    dataCollectionScreenChangeNotifier =
        Provider.of<DataCollectionScreenChangeNotifier>(context, listen: false);
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                if (_sharedPreferences
                    .containsKey('$mainCategoryTitle$subCategoryTitle')) {
                  _invitationDataList = (_sharedPreferences
                      .getStringList('$mainCategoryTitle$subCategoryTitle'))!;
                  if (_invitationDataList.isNotEmpty) {
                    for (String hintText in hintTextList) {
                      if (hintText.toLowerCase().contains('date')) {
                        List<String> list = _invitationDataList[_i].split('/');
                        pickedDate = DateTime(int.parse(list[2]),
                      ...
                      if (hintText.toLowerCase().contains('time')) {
                        ...
                        String hours = (list2[1] == 'pm')
                                ? (int.parse(list1[0]) + 12).toString()
                                : list1[0],
                            minutes = list2[0];
                        pickedTime = TimeOfDay(
                            hour: int.parse(hours), minute: int.parse(minutes));
                      }
                      textFieldControllerMap[hintText]!.text =
                          _invitationDataList[_i];
                      _i++;
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text(
                        'error obtaining recent invitation data',
                        style: TextStyle(
                          fontFamily: 'Roboto',
                        ),
                      ),
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    content: Text(
                      'no recent invitation data available',
                      style: TextStyle(
                        fontFamily: 'Roboto',
                      ),
                    ),
                ...
                print(
                    '/././././././././././././././././.....mainCategoryTitle: $mainCategoryTitle    /    subCategoryTitle: $subCategoryTitle');
              },
            ),
            IconButton(
              icon: const Icon(
                ...
                if (textFieldDataMap.length == hintTextList.length) {
                  ...
                  if (mainCategoryTitle == 'Announcements') {
                    ...
                    selectedContactList.add(Contact(
                        name: '$subCategoryTitle$mainCategoryTitle'
                            .trim()
                            .replaceAll(' ', '')));
                    Navigator.pushNamed(
                        context, CardCollectionGridViewScreen.ROUTE_NAME);
                  } else {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: RotatedBox(
                                  quarterTurns: -1,
                                  child: Selector<
                                      DataCollectionScreenChangeNotifier, bool>(
