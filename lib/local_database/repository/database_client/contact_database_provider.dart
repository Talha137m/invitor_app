...
//     Database invitorDatabase = await DatabaseClient.getInstance.database;
//     return await invitorDatabase.update(Contact.table_Name, contact.toMap(),
//         where: '${Contact.id_Column} =?', whereArgs: [contact.primaryKey]);
//   }

//   Future<int> delete({required int primaryKey}) async {
//     Database invitorDatabase = await DatabaseClient.getInstance.database;
//     return await invitorDatabase.delete(Contact.table_Name,
//         where: '${Contact.id_Column} =?', whereArgs: [primaryKey]);
//   }
