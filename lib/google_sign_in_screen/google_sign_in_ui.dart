...
class _MyGoogleSignInState extends State<MyGoogleSignIn>
  ...
  void registerFirebaseAuthenticationStateChangeListeners() {
    FirebaseAuth.instance.authStateChanges().listen((User? user) {
      if (user == null) {
        print(
            'authStateChanges...................User is currently signed out!');
      } else {
    ...
    FirebaseAuth.instance.idTokenChanges().listen((User? user) {
      if (user == null) {
        print(
            'idTokenChanges.....................User is currently signed out!');
      } else {
    ...
    FirebaseAuth.instance.userChanges().listen((User? user) {
      if (user == null) {
        print(
            'userChanges........................User is currently signed out!');
      } else {
                ...
                setState(() {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    ...
                    action: SnackBarAction(
                      label: 'detail',
                      onPressed: () =>
                          showErrorDetailsDialog(errorDescription: e.message!),
                    ),
                  ));
                });
              } catch (e) {
