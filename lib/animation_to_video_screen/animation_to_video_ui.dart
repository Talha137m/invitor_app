...
const temporaryFramesDirectory = 'storage/emulated/0/Invitor/Frames';

Future<void> capturePngCard() async {
  RenderRepaintBoundary repaintBoundary = globalKeyOfWeddingCard.currentContext!
...
class _AnimationToVideoScreenState extends State<AnimationToVideoScreen> with AnimationToVideoBehavior, ConnectivityHandler {
  ...
  Future<void> createRequiredDirectories() async {
    ...
    await Directory('storage/emulated/0/Invitor').create().then((value) async {
      await Directory('storage/emulated/0/Invitor/Videos')
          .create()
          .then((value) {})
          .catchError((error) {
        print(error);
     ...
     await Directory('storage/emulated/0/Invitor/Images')
          .create()
          .then((value) {})
          .catchError((error) {
        print(error);
      ...
      await Directory('storage/emulated/0/Invitor/Gifs')
          .create()
          .then((value) {})
          .catchError((error) {
        print(error);
    ...
    if(!(await Directory('storage/emulated/0/Invitor/Videos').exists())) {
      await Directory('storage/emulated/0/Invitor/Videos').create();
    }
    if(!(await Directory('storage/emulated/0/Invitor/Images').exists())) {
      await Directory('storage/emulated/0/Invitor/Images').create();
    }
    if(!(await Directory('storage/emulated/0/Invitor/Gifs').exists())) {
      await Directory('storage/emulated/0/Invitor/Gifs').create();
    }
