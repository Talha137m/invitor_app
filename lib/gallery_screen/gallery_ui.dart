...
class _GalleryScreenState extends State<GalleryScreen> with GalleryBehavior {
                ...
                onPressed: () async {
                  ...
                  switch (name) {
                    case 'Images':
                      {
                        originalImageList =
                            Directory('storage/emulated/0/Invitor/Images/')
                                .listSync();
                    ...
                    case 'Videos':
                      {
                        originalVideoList =
                            Directory('storage/emulated/0/Invitor/Videos/')
                                .listSync();
                    ...
                    case 'Gifs':
                      {
                        originalGifsList =
                            Directory('storage/emulated/0/Invitor/Gifs/')
                                .listSync();
              ...
              title: SingleChildScrollView(
                  ...
                  child: Text(
                    filteredImageList[index]
                        .path
                        .replaceFirst(
                        'storage/emulated/0/Invitor/Images/', '')
                        .substring(
                        4,
                        filteredImageList[index]
                            .path
              ...
              title: SingleChildScrollView(
                  ...
                  child: Text(
                    filteredVideoList[index]
                        .path
                        .replaceFirst('storage/emulated/0/Invitor/Videos/', '')
                        .substring(
                            4,
                            filteredVideoList[index]
                                    .path
                                    .replaceFirst(
                                        'storage/emulated/0/Invitor/Videos/',
                                        '')
                                    .length -
                                4),
                    style: const TextStyle(fontFamily: 'Roboto'),
              ...
              title: SingleChildScrollView(
                  ...
                  child: Text(
                    filteredGifsList[index]
                        .path
                        .replaceFirst('storage/emulated/0/Invitor/Gifs/', '')
                        .substring(
                            4,
                            filteredGifsList[index]
                                    .path
                                    .replaceFirst(
                                        'storage/emulated/0/Invitor/Gifs/', '')
                                    .length -
                                4),
                    style: const TextStyle(fontFamily: 'Roboto'),
                    maxLines: 1,
  ...
  Future<void> createOriginalPathList() async {
    ...
    if (await Directory('storage/emulated/0/Invitor/Images/').exists()) {
      originalImageList =
          Directory('storage/emulated/0/Invitor/Images/').listSync();
      createFilteredImagePathList();
    }
    if (await Directory('storage/emulated/0/Invitor/Videos/').exists()) {
      originalVideoList =
          Directory('storage/emulated/0/Invitor/Videos/').listSync();
      createFilteredVideoPathList();
    }
    if (await Directory('storage/emulated/0/Invitor/Gifs/').exists()) {
      originalGifsList =
          Directory('storage/emulated/0/Invitor/Gifs/').listSync();
      createFilteredGifPathList();
    }
  }
  ...
  void createFilteredImagePathList() {
    ...
    if (currentMainCategory != 'All') {
      for (var element in originalImageList) {
        if (element.path
                .replaceFirst('storage/emulated/0/Invitor/Images/', '')
                .substring(0, 3) ==
      ...
      for (int i = 0; i < 5; i++)
        PopupMenuItem(
          onTap: () {
            ...
            Fluttertoast.showToast(msg: (mainCategoryTitleList[i]));
          },
          child: ListTile(
            title: Text(
        ...
        PopupMenuItem(
          onTap: () {
            ...
            Fluttertoast.showToast(
                msg: (subCateGoryTitleMapOfLists[currentMainCategory]![i]));
          },
          child: ListTile(
            title: Text(
              subCateGoryTitleMapOfLists[currentMainCategory]![i],
